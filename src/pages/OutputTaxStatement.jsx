...
export default function OutputTaxStatement() {
  ...
  return (
    <Layout 
      ...
      subtitle="View and export Output Tax reports for your invoices"
      actions={
    ...
    >
      <div className="p-4 lg:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm text-slate-500 dark:text-slate-400">Total Output Tax</p>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-slate-50 dark:bg-slate-700/50 border-b border-slate-200 dark:border-slate-700">
                      ...
                      <th className="text-right px-6 py-4 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Output Tax</th>
                  ...
                  return (
                    <div key={invoice.id} className="p-4">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <div className="text-right">
                          <p className="text-slate-500 dark:text-slate-400">Output Tax</p>
